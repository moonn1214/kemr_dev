...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './kemr-medical-treatment.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KEMRMEDICALTREATMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_KEMRMEDICALTREATMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_KEMRMEDICALTREATMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_KEMRMEDICALTREATMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_KEMRMEDICALTREATMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_KEMRMEDICALTREATMENT actions', async () => {
      const expectedActions = [
        {
