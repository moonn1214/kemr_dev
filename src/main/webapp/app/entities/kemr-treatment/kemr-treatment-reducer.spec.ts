...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KEMRTREATMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_KEMRTREATMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_KEMRTREATMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_KEMRTREATMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_KEMRTREATMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_KEMRTREATMENT actions', async () => {
      const expectedActions = [
        {
