...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KEMRDIAGNOSIS_LIST actions', async () => {
    ...
    it('dispatches FETCH_KEMRDIAGNOSIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_KEMRDIAGNOSIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_KEMRDIAGNOSIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_KEMRDIAGNOSIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_KEMRDIAGNOSIS actions', async () => {
      const expectedActions = [
        {
