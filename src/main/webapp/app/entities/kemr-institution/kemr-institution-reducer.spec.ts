...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KEMRINSTITUTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_KEMRINSTITUTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_KEMRINSTITUTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_KEMRINSTITUTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_KEMRINSTITUTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_KEMRINSTITUTION actions', async () => {
      const expectedActions = [
        {
