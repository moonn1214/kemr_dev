...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KEMRPATIENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_KEMRPATIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_KEMRPATIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_KEMRPATIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_KEMRPATIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_KEMRPATIENT actions', async () => {
      const expectedActions = [
        {
