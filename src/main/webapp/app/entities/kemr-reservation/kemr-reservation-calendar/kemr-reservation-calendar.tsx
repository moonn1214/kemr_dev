...
const ReactCalendar = () => {
  ...
  const creatNewReservation = () => {
    navigate('/kemr-reservation/new', { state: { selectDate } });
  };

  return (
    <div className="calendar">
      <div className="calendar-container">
        <Calendar onChange={setDate} value={date} minDate={new Date()} onClickDay={creatNewReservation} />

        <div className="text-gray-500">{selectDate}</div>
      </div>
    </div>
  );
};
