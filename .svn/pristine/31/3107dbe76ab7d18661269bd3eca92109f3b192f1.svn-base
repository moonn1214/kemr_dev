...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './kemr-medical-bill.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KEMRMEDICALBILL_LIST actions', async () => {
    ...
    it('dispatches FETCH_KEMRMEDICALBILL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_KEMRMEDICALBILL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_KEMRMEDICALBILL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_KEMRMEDICALBILL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_KEMRMEDICALBILL actions', async () => {
      const expectedActions = [
        {
