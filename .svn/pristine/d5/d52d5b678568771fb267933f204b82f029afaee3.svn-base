...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './kemr-prescription.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KEMRPRESCRIPTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_KEMRPRESCRIPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_KEMRPRESCRIPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_KEMRPRESCRIPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_KEMRPRESCRIPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_KEMRPRESCRIPTION actions', async () => {
      const expectedActions = [
        {
