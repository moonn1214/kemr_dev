...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KEMRMEDICINE_LIST actions', async () => {
    ...
    it('dispatches FETCH_KEMRMEDICINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_KEMRMEDICINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_KEMRMEDICINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_KEMRMEDICINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_KEMRMEDICINE actions', async () => {
      const expectedActions = [
        {
