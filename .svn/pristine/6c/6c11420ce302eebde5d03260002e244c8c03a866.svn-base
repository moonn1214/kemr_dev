...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KEMRRESERVATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_KEMRRESERVATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_KEMRRESERVATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_KEMRRESERVATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_KEMRRESERVATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_KEMRRESERVATION actions', async () => {
      const expectedActions = [
        {
