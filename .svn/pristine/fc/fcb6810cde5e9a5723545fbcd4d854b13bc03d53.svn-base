...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KEMRDOCTOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_KEMRDOCTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_KEMRDOCTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_KEMRDOCTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_KEMRDOCTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_KEMRDOCTOR actions', async () => {
      const expectedActions = [
        {
